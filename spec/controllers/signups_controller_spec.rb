...
describe SignupsController do
  ...
  #       Signup.any_instance.should_receive(:update).with({ "email" => "MyString" })
  #       put :update, {:id => signup.to_param, :signup => { "email" => "MyString" }}, valid_session
  #     end
  # 
  #     it "assigns the requested signup as @signup" do
  #       signup = Signup.create! valid_attributes
  ...
  #       # Trigger the behavior that occurs when invalid params are submitted
  #       Signup.any_instance.stub(:save).and_return(false)
  #       put :update, {:id => signup.to_param, :signup => { "email" => "invalid value" }}, valid_session
  #       assigns(:signup).should eq(signup)
  #     end
  # 
